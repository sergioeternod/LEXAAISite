...
## 1. Introducción y Dashboard (Panel Institucional)
...
- El **Riesgo Promedio** de nuestra cartera de interés está en 68/100.
- En las gráficas, podemos ver claramente la tendencia de la actividad legislativa de los últimos meses y cómo se distribuye por sector. Vemos que **Energía** y **Fintech** son los sectores con mayor movimiento actualmente.
- Y abajo, tenemos un acceso rápido a los últimos expedientes que han sufrido modificaciones."

---

## 2. Exploración y Búsqueda Semántica
*(Acción: Clic en "Explorar" en el menú lateral)*

**Narrativa:**
"Supongamos que soy un analista del sector tecnológico o financiero y necesito saber qué está pasando. Vamos a la sección de **Explorar**.

El buscador de LEXA no es un buscador tradicional de palabras exactas; utiliza **búsqueda semántica**. 
*(Acción: Escribir "Fintech" o "Ciberseguridad" en el buscador)*
Al buscar 'Ciberseguridad', el sistema me trae inmediatamente la *Ley Federal de Ciberseguridad*. 

Vean cómo en los resultados de búsqueda ya tengo información procesada: el folio, el tema, el estado actual y, muy importante, un **Score de Riesgo** calculado automáticamente. Vamos a entrar a este expediente."

*(Acción: Clic en el expediente de Ciberseguridad o Ley Fintech)*

---

## 3. Análisis Profundo de un Expediente (Anti-Alucinación)
...
Del lado derecho, tenemos estructurado todo el contexto:
- El **Timeline Legislativo** para saber exactamente en qué etapa del proceso estamos.
- Los **Actores Clave** (quién la promueve, qué comisión la dictamina).
...
## 5. Centro de Alertas
*(Acción: Clic en "Alertas" en el menú lateral)*

**Narrativa:**
"Finalmente, no podemos estar buscando manualmente todos los días. Vamos al **Centro de Alertas**.

El motor de reglas de LEXA monitorea constantemente las fuentes oficiales. Si hay un cambio de estado, si se publica un nuevo dictamen, o si el score de riesgo de una iniciativa de nuestro interés sube, el sistema genera una alerta.

Aquí podemos ver alertas categorizadas por severidad (Alta, Media). Por ejemplo, tenemos una alerta roja indicando que *'Se publicó el decreto de Compras Consolidadas en el DOF y entra en vigor mañana'*. 

Esto garantiza que ninguna institución o empresa sea tomada por sorpresa ante un cambio regulatorio."
...
¿Tienen alguna pregunta o les gustaría que busquemos algún tema en particular en el sistema?"
