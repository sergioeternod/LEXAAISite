...
export const legisladores = [
  ...
  { id: "leg-006", nombre: "Octavio Martínez Vargas", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Salud", "Movilidad"], avatar: "OM", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "favor" }], iniciativas_generadas: [] },
  ...
  { id: "leg-008", nombre: "Edmundo Luis Valdeña Bastida", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Gobernación", "Finanzas"], avatar: "EV", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "abstencion" }], iniciativas_generadas: [] },
  ...
  { id: "leg-010", nombre: "Javier Cruz Jaramillo", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Movilidad", "Seguridad"], avatar: "JC", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "abstencion" }], iniciativas_generadas: [] },
  { id: "leg-011", nombre: "Elena García Martínez", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Justicia", "Gobernación"], avatar: "EG", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "favor" }], iniciativas_generadas: [] },
  ...
  { id: "leg-025", nombre: "Brenda Colette Miranda Vargas", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Justicia", "Gobernación"], avatar: "BM", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "abstencion" }], iniciativas_generadas: [] },
  ...
  { id: "leg-027", nombre: "Yesica Yanet Rojas Hernández", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Salud", "Movilidad"], avatar: "YR", historial_votos: [{ votacion_id: "vot-001", sentido: "contra" }, { votacion_id: "vot-002", sentido: "favor" }], iniciativas_generadas: [] },
  { id: "leg-028", nombre: "Valentín Martínez Castillo", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Seguridad", "Justicia"], avatar: "VM", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "abstencion" }], iniciativas_generadas: [] },
  ...
  { id: "leg-040", nombre: "Carlos Antonio Martínez Zurita Trejo", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Finanzas", "Educación"], avatar: "CM", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "abstencion" }], iniciativas_generadas: [] },
  { id: "leg-041", nombre: "María del Carmen de la Rosa Mendoza", partido: "MORENA", color: "#B3282D", estado: "Edomex", tipo_eleccion: "MR", asistencia: 95, lealtad: 97, lealtad_ejecutivo: 96, comisiones: ["Salud", "Movilidad"], avatar: "MR", historial_votos: [{ votacion_id: "vot-001", sentido: "favor" }, { votacion_id: "vot-002", sentido: "favor" }], iniciativas_generadas: [] },
  ...
  { id: "leg-067", nombre: "Sara Alicia Ramírez de la O", partido: "PT", color: "#D9131C", estado: "Edomex", tipo_eleccion: "RP", asistencia: 94, lealtad: 95, lealtad_ejecutivo: 96, comisiones: ["Justicia", "Gobernación"], avatar: "SR", historial_votos: [{ votacion_id: "vot-001", sentido: "contra" }, { votacion_id: "vot-002", sentido: "contra" }], iniciativas_generadas: [] },
